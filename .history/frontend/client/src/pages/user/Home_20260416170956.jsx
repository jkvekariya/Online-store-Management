...
function Home() {
  ...
  const [categories, setCategories] = useState([
    { _id: '1', name: 'Topwear', image: '/photos/shirt.png', count: 25 },
    { _id: '2', name: 'Bottomwear', image: '/photos/jeans.png', count: 18 },
    { _id: '3', name: 'Accessories', image: '/photos/accessories.png', count: 12 },
    { _id: '4', name: 'Shoes', image: '/photos/shoes.png', count: 15 }
  ]);
