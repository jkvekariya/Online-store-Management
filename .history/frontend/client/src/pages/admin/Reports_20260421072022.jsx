                    ...
                    <div className="sales-report-section">
                        ...
                        <div className="filters-bar" style={{ display: 'flex', alignItems: 'flex-end', gap: '1rem' }}>
                            <div className="filter-group">
                                ...
                                <input type="date" name="from" value={filters.from} max={todayStr} onChange={handleFilterChange} />
                            </div>
                            <div className="filter-group">
                                <label><FiFilter /> To:</label>
                                <input type="date" name="to" value={filters.to} max={todayStr} onChange={handleFilterChange} />
                            </div>
                            <button
                                type="button"
                                className="apply-filter-btn"
                                style={{ marginLeft: 'auto', padding: '0.7rem 1.5rem', border: '1px solid #111', borderRadius: 6, background: '#111', color: '#fff', fontWeight: 600, cursor: 'pointer', transition: 'background 0.2s' }}
